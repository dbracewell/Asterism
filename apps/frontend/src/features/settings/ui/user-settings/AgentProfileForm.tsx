    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="bg-card text-card-foreground flex h-full w-full! max-w-full! flex-col overflow-clip p-0! sm:h-[80%]! md:max-w-250!">
        ...
        <form
          ...
          className="flex min-h-0 flex-1 flex-col space-y-6 overflow-y-scroll px-2"
        >
          <Controller
            control={form.control}
            name="id"
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="form-agentProfile-maxSteps">
                      <Required>Max Steps</Required>
                    </FieldLabel>
                    <FieldDescription>
                      The maximum number of steps the agent can take to answer a
                      question.
                    </FieldDescription>
                    <Input
                      type="number"
          ...
          <FieldSet className="@container flex min-h-0 flex-1 flex-col">
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              ...
              >
                ...
                />
                <Label htmlFor="thinking_budgent">Thinking Budget Tokens</Label>
                <Input
                  id="thinking_budgent"
                  type="number"
                  value={field.value.max_tokens ?? ""}
