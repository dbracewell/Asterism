      ...
      <div className="mx-auto flex w-full max-w-[80%] flex-col sm:max-w-3xl">
        <div className="bg-input text-foreground relative flex-col content-center overflow-clip rounded-xl border">
          {attachedFiles.length > 0 && (
            <div
              className="relative flex flex-wrap items-center gap-2 overflow-hidden p-2"
              aria-live="polite"
            >
              {attachedFiles.map((file) => (
                <Badge
                  className="group relative h-7 max-w-56 px-1 text-[13px]"
                  key={file.id}
          ...
          <form
            className="flex w-full flex-1 flex-col gap-1 overflow-clip rounded-[inherit] p-1"
            ...
            <Textarea
              ...
              onKeyDown={(event) => {
                if (
                  ...
                  event.preventDefault();
                  if (canSubmit) void submitPrompt();
                }
              }}
