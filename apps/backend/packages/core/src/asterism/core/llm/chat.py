...
from asterism.core.data.models import ChatModel, LLMMessage, MessageModel
...
from asterism.core.llm.llm_event import (
    LLMEvent,
    LLMEventType,
)
from asterism.core.llm.tool_registory import ToolCall, ToolResult, tool_registry
...
class WebSocketChatConnection:
    ...
    async def _process_tool_calls(
        ...
        tasks = [tool_registry.invoke_tool(tc) for tc in tool_calls]
