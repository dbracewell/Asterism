...
Status: SP-9.1–SP-9.3, US-9.5, and US-9.1 completed; US-9.2 implementation complete and awaiting user confirmation.
...
- [~] US-9.2 — Fail safely on invalid configuration without leaking secrets (implementation complete; awaiting user confirmation)
