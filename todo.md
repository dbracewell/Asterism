...
Status: SP-9.1–SP-9.3 and US-9.1, US-9.2, and US-9.5 completed; US-9.3 canceled as not applicable; US-9.4 implementation complete and awaiting user confirmation.
...
- [~] US-9.4 — Keep configuration deterministic across CI and containers (implementation complete; awaiting user confirmation)
